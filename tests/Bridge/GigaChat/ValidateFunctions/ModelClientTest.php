...
use FM\AI\Platform\Bridge\GigaChat\ValidateFunctions\ModelClient;
...
final class ModelClientTest extends TestCase
{
    ...
    public function testItIsExecutingTheCorrectRequestWithDefaultValues(): void
    {
        $resultCallback = static function (string $method, string $url, array $options): HttpResponse {
            ...
            self::assertSame('https://gigachat.devices.sberbank.ru/api/v1/functions/validate', $url);
        ...
        $modelClient->request(new GigaChat(), []);
    }

    #[TestWith(['https://gigachat.devices.sberbank.ru/api/v1/functions/validate'])]
